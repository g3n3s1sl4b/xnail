...
class EbClientAmocrm
{
    ...
    public function create_note($id, $text)
    ...
    public function update_lead($id_lead, $leads)
    { //'PATCH',
    ...
    public function get_contacts($idContacts)
    ...
    public function get_contacts_by_pnone($phone)
    { //выводит список всех контактов
